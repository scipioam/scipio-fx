...
public class MyScriptRunner {
    ...
    public void setRunListener(MyScriptRunListener runListener) {
    ...
    private void executeFullScript(Reader reader) {
        ...
        try {
            ...
            if (runListener != null) {
                runListener.onRunning(command, logWriter, errorLogWriter ,1);
            }
    ...
    private void executeLineByLine(Reader reader) {
        ...
        try {
            BufferedReader lineReader = new BufferedReader(reader);
            String line;
            int finishedCommandsCount = 0;
            while ((line = lineReader.readLine()) != null) {
                finishedCommandsCount = handleLine(command, line, finishedCommandsCount);
            }
            commitConnection();
    ...
    private int handleLine(StringBuilder command, String line, int finishedCommandsCount) throws SQLException {
        ...
        if (lineIsComment(trimmedLine)) {
            ...
            if (runListener != null) {
                runListener.onRunning(command.toString(), logWriter, errorLogWriter ,finishedCommandsCount);
            }
