...
public class StringUtils {
    ...
    /**
     * 判断字符串是否为http的url
     * 匹配诸如：http://regxlib.com | http://electronics.cnet.com/electronics/0-6342366-8-8994967-1.html
     * 不匹配：www.yahoo.com
     */
     ...
     * @return 插入过的字符串
     */
    public static String insertStr(int offset, String oldStr, String insertStr) {
